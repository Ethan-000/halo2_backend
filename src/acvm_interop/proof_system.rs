...
impl ProofSystemCompiler for Halo2 {
    ...
    fn preprocess(&self, circuit: &NoirCircuit) -> Result<(Vec<u8>, Vec<u8>), BackendError> {
        ...
        let params = constuct_halo2_params_from_aztec_crs(self.get_exact_circuit_size(circuit).unwrap());
